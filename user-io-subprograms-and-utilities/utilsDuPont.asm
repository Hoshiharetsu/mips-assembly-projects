...
# purpose:Take an input parameter and return that parameter multiplied by 10 
#using only 2 shifts and one add operation.
 Mult10:
 	sll $t0, $a0, 3
 	sll $t1, $a0, 1
 	add $v0, $t0, $t1
...
#The first is the value that has been shifted 1 bit using a right circular shift, 
#and the second is the value of the bit which has been shifted.
RCShift:
	andi $v1, $a0, 1
    	srl  $t0, $a0, 1
    	sll  $t1, $v1, 31
...
# author: Rebecca DuPont
# purpose: Take an input parameter and return two values. 
#The first is the value that has been shifted 1 bit using a left circular shift, 
#and the second is the value of the bit which has been shifted.
LCShift:
	srl  $v1, $a0, 31
    	sll  $t0, $a0, 1
